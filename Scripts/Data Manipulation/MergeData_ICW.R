# Script to merge WhatsApp and Alfabetizacion dataset

# ------------------------------------------------------------------------------
# Read data
survey_wa <- read.csv('Datasets/WhatsApp/survey_final.csv')
survey_alf <- read.csv('Datasets/Alfabetizacion/survey_final.csv')

# Fix data and merge
source('Scripts/General Scripts/CommonFixes_Merge.R')

# Working with demographics variables -------------------------------------
...
write.csv(final, 'Datasets/Final sets/survey_final_ICW.csv', row.names = F)
